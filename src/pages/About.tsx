    ...
    <>
      <Section className="bg-gradient-to-br from-slate-900 to-slate-800 py-40 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto relative z-10">
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-blue-300 via-green-300 to-blue-300 bg-clip-text text-transparent">{t('aboutPageTitle')}</h1>
