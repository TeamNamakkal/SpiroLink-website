        ...
        <div className="max-w-4xl space-y-8">
          ...
          <div>
            ...
            <p className="text-slate-700 mb-4">
              ...
              or software) on GreenFluxion's website for personal, non-commercial transitory viewing
          ...
          <div>
            ...
            <p className="text-slate-700">
              The materials on GreenFluxion's website are provided on an 'as is' basis. GreenFluxion
          ...
          <div>
            ...
            <p className="text-slate-700">
              In no event shall GreenFluxion or its suppliers be liable for any damages (including,
              without limitation, damages for loss of data or profit, or due to business
              interruption) arising out of the use or inability to use the materials on
              GreenFluxion's website.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-700">
              The materials appearing on GreenFluxion's website could include technical,
              typographical, or photographic errors. GreenFluxion does not warrant that any of the
              materials on the website are accurate, complete, or current. GreenFluxion may make
          ...
          <div>
            ...
            <p className="text-slate-700">
              GreenFluxion has not reviewed all of the sites linked to its website and is not
              responsible for the contents of any such linked site. The inclusion of any link does
              not imply endorsement by GreenFluxion of the site. Use of any such linked website is
          ...
          <div>
            ...
            <p className="text-slate-700">
              GreenFluxion may revise these terms of service for the website at any time without
